...
- **Hole** adds a 2 m square water-filled opening. Drag its edge or use arrow keys to move it; Remove/Delete fills it back in. The original 5 m pool is also a hole object. Touching or overlapping squares share one opening, with no interior walls and waves crossing the join. Each square remains individually editable. Holes cannot be placed through supporting solid geometry.
